...
extern Std_ReturnType RCC_HSClockCtrl(u32 Copy_u8Clockname,u32 Copy_u8State ,u32 Copy_u8ClockRDY);

/*  Description : This API configure system clock source select                                */
extern Std_ReturnType RCC_ClockSource(u32 Copy_u8Clockname,u32 Copy_u8SysClkState);

/*  Description : This API configure PLL clock select                                          */
extern Std_ReturnType RCC_PLLSRC(u32 Copy_u8Clockname,u32 Copy_u8MulOrDiv,u32 Copy_u8Operation);

/*  Description : This API configure Enabling nd Disabling Low Speed Clock Source              */
extern Std_ReturnType RCC_LSClockCtrl(u32 Copy_u8Clockname,u32 Copy_u8State ,u32 Copy_u8ClockRDY);
