 ...
 *                  E_NOT_OK
 */
Std_ReturnType LCD_Config(void)
{
	u8 idx;
 ...
 *                  E_NOT_OK
 */
Std_ReturnType LCD_WriteDATA(const u8 * Copy_u8word ,u8 Copy_u8Length)
{
	u8 idx;
 ...
 *                  E_NOT_OK
 */
/*Std_ReturnType LCD_WriteCMD(const u8 Copy_u8Cmd)
{
	Std_ReturnType state = E_NOT_OK;
 ...
 *                  E_NOT_OK
 */
Std_ReturnType LCD_GOTO(u8 Copy_u8PosX, u8 Copy_u8PosY)
{
	Std_ReturnType state = E_NOT_OK;
	if(LCD_CurrentProcess == Idle_Process)
	{
...
Std_ReturnType LCD_Cursor_ON_OFF(u8 Copy_CursorMode)
{
	Std_ReturnType state = E_NOT_OK;;
	if(LCD_CurrentProcess == Idle_Process)
	{
		...
		LCD_u8CurrentCMD = Copy_CursorMode;
